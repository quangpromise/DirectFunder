...
export default function CasesPage() {
  ...
  const updateRefundYearAlarm = useAppStore((s) => s.updateRefundYearAlarm);
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      {/* Bo góc + viền cho cả khối bảng (thêm 2026-08-24, làm mới layout kiểu Apple — card
          rõ ràng thay vì bảng tràn viền) — cùng cách Orders/CPA Review đã dùng sẵn
          (rounded-xl border), giờ đồng bộ cho cả bảng Hồ sơ. */}
      <div className="flex-1 table-card">
        <div className="grid text-sm" data-grid-root style={{ gridTemplateColumns }}>
          ...
          />
          <div
            className="group/head sticky top-0 z-30 flex items-center justify-center gap-1 table-head-cell px-2 py-2.5 text-[10px] font-semibold uppercase tracking-normal text-table-head-text"
          ...
          <div
            className="sticky top-0 z-30 flex items-center justify-center whitespace-nowrap table-head-cell px-3 py-2.5 text-center text-[10px] font-semibold uppercase tracking-normal text-table-head-text"
          ...
          <div
            className="group/head sticky top-0 z-20 flex items-center justify-center gap-1 whitespace-nowrap table-head-cell px-3 py-2.5 text-center text-[10px] font-semibold uppercase tracking-normal text-table-head-text"
            style={{ gridRow: "1" }}
          >
          ...
          <div
            className="sticky top-0 z-20 flex items-center justify-center whitespace-nowrap table-head-cell px-3 py-2.5 text-center text-[10px] font-semibold uppercase tracking-normal text-table-head-text"
            style={{ gridRow: "1" }}
          >
          ...
          {filtered.map((row, rowIndex) => (
            <RowCells
              ...
              updateRefundYearAlarm={updateRefundYearAlarm}
        ...
        col.id === "ssn" ? (
          ...
          >
            ...
            <CaseRefundStatusButton
              ...
              refundYearAlarm={row.refundYearAlarm ?? {}}
              ...
              onSetAlarm={(year, date) => updateRefundYearAlarm(row.id, year, date)}
